...
export default function App() {
  const { connect, disconnect, status, currentAnalysis, history, mode, setMode } = useGeminiLive();
        ...
        <header className="flex flex-col md:flex-row justify-between items-center mb-10 border-b border-slate-800 pb-6 gap-6">
          <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm">Real-time Call Intelligence</p>
            </div>
          </div>
            ...
            {isConnected ? (
                <>
                    ...
                    <span className="flex items-center gap-1">
                        ...
                        Observer Mode ({mode === 'single_shot' ? 'Single Shot' : 'Continuous'})
                    </span>
                </>
            ) : (
